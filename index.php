...
<body>
    <header>
        <div class="top">
            <div class="left">
                <img src="https://cdn.ilpost.it/wp-content/uploads/2015/09/google-logo.jpg?x72029" alt="Google" class="logo">
    ...
    <footer>
        <ul>
            <li>Google</li>
            <li><span>-</span> Tutto su Google</li>
            <li><span>-</span> Privacy</li>
            <li><span>-</span> Termini</li>
        </ul>
        <div>
            <img src="https://cdn0.iconfinder.com/data/icons/network-and-communication-3-9/65/109-512.png" alt="">
